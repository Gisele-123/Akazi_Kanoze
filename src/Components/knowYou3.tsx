...
const KnowYou3 = ({navigation}: knowYou3Props) => {
  ...
  const [isMore5Checked, setIsMore5Checked] = useState(false);
  ...
  const handleMore5Check = () => {
    setIsMore5Checked(!isMore5Checked);
  };
  const handleSubmit = () => {
      ...
      <View style={{ flex: 1, padding: 20, borderWidth: 0.2, borderColor: '#ccf', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
          ...
          <TouchableOpacity
            ...
            >
              <Text style={{ color: isFreshChecked ? '#000' : '#ccc', fontWeight: isFreshChecked ? '600' : 'normal' }}>Physiology</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
            ...
            >
              <Text style={{ color: isOneChecked ? '#000' : '#ccc', fontWeight: isOneChecked ? '600' : 'normal'}}>IT & Electrical engineering</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
            ...
            >
              <Text style={{ color: is2To4Checked ? '#000' : '#ccc', fontWeight: is2To4Checked ? '600' : 'normal' }}>Management & Accounting</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
            ...
            >
              <Text style={{ color: isMore4Checked ? '#000' : '#ccc', fontWeight: isMore4Checked ? '600' : 'normal'}}>Architecture & Civil engineering</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                backgroundColor: isMore5Checked ? '#fff' : '#fff',
                padding: 10,
                borderRadius: 5,
                width: 245,
                borderWidth: 2,
                borderColor: isMore5Checked ? 'blue' : '#ccc'
              }}
              onPress={handleMore5Check}
            >
              <Text style={{ color: isMore5Checked ? '#000' : '#ccc', fontWeight: isMore5Checked ? '600' : 'normal'}}>Others</Text>
            </TouchableOpacity>
          </View>
